pfad <- setwd("C:/Users/Michaela Vorndran/Dropbox/Studium/Master/Datenanalyse/Github/msc-phygeo-class-of-2016-MVorndran/data_analysis/da-ws-11-1/daten/")
...
print(TTest)
TTest$p.value
# Die Intercept-Werte aus dem Cross Check sind signifikat verschieden von dem Intercept-Wert des Modells (8.277572) 
# Das deutet auf einen Einfluss des NAO auf die Temperatur in Coelbe hin.